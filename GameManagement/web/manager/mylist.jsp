...
<script>
    $(function () {
        ...
        $.ajax({
            type: "get",
            url: "../MyServlet?action=getmanager",
    ...
    function submitForm(){
        ...
        $('#ff').form('submit', {
            url: '../MyServlet?action=updatemanager',
            onSubmit: function () {
...
<div class="easyui-panel" title="编辑信息" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post">
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" id="managername" name="managername" style="width:100%" labelPosition="top"
