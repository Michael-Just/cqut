...
<div class="easyui-layout" style="width:100%;height:100%;">
    ...
    <div data-options="region:'north'" style="height:70px;">
        ...
        <div style="float: right;margin: 30px;">
            <div>欢迎您！管理员 <%=session.getAttribute("username")%>
    ...
    <div data-options="region:'west',split:true" title="管理员" style="width:200px;">
        <div id="menu" class="easyui-accordion" data-options="fit:true">
            <div title="篮球比赛" data-options="iconCls:'icon-ok'" style="overflow:auto">
                <a class="easyui-linkbutton" style="margin: 5px;width: 180px;height: 30px"
                   data-url="manager/teamlist.jsp" data-options="iconCls:'icon-add'">球队安排</a>
                <a class="easyui-linkbutton" style="margin: 5px;width: 180px;height: 30px"
                   data-url="manager/trainlist.jsp" data-options="iconCls:'icon-add'">训练安排</a>
                <a class="easyui-linkbutton" style="margin: 5px;width: 180px;height: 30px"
                   data-url="manager/gamelist.jsp" data-options="iconCls:'icon-add'">比赛安排</a>
                <a class="easyui-linkbutton" style="margin: 5px;width: 180px;height: 30px"
                   data-url="manager/sitelist.jsp" data-options="iconCls:'icon-add'">场地管理</a>
                <a class="easyui-linkbutton" style="margin: 5px;width: 180px;height: 30px"
                   data-url="manager/coachlist.jsp" data-options="iconCls:'icon-add'">教练管理</a>
                <a class="easyui-linkbutton" style="margin: 5px;width: 180px;height: 30px"
                   data-url="manager/refereelist.jsp" data-options="iconCls:'icon-add'">裁判管理</a>
            </div>
            <div title="个人信息" data-options="iconCls:'icon-ok'" style="overflow:auto">
                <a class="easyui-linkbutton" style="margin: 5px;width: 180px;height: 30px"
                   data-url="manager/mylist.jsp" data-options="iconCls:'icon-add'">我的信息</a>
            </div>
        </div>
    </div>
