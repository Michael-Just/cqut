...
<script>
    $(function () {
        ...
        $('#btnAdd').click(function () {
            $('#dd').dialog({
                ...
                closed: false,
                cache: false,
                href: 'refereeform.jsp?action=add&r=' + Math.random(),
                modal: true,
                buttons: [{
                    text: '保存',
                    iconCls: 'icon-save',
            ...
            if ($('#dg').datagrid('getSelected') == null) {
                ...
                $.messager.confirm('确认', '是否要删除数据？', function (r) {
                    if (r) {
                        ...
                        $.ajax({
                            type: "get",
                            url: "../RefereeServlet?action=delete",
                            data: {rno: row.rno},
        ...
        $('#btnEdit').click(function () {
            if ($('#dg').datagrid('getSelected') == null) {
                ...
                $('#dd').dialog({
                    ...
                    closed: false,
                    cache: false,
                    href: 'refereeform.jsp?action=edit&r=' + Math.random(),
                    modal: true,
                    buttons: [{
                        text: '保存',
                        iconCls: 'icon-save',
    ...
    function SaveData(action) {
        ...
        $('#ff').form('submit', {
            url: '../RefereeServlet?action=' + action,
            onSubmit: function () {
