    ...
    <form id="ff" method="post">
        ...
        <div style="margin-bottom:20px">
            <select class="easyui-combobox" id="tname" name="tname" style="width:100%" labelPosition="top" limitToList="true"
                    data-options="label:'比赛球队甲队:',required:true,url:'../GetServlet?action=gettnameb',method:'get',textField:'tname',valueField:'tname'">
            </select>
        </div>
        <div style="margin-bottom:20px">
            <select class="easyui-combobox" id="tname2" name="tname2" style="width:100%" labelPosition="top" limitToList="true"
                    data-options="label:'比赛球队乙队:',required:true,url:'../GetServlet?action=gettnameb',method:'get',textField:'tname',valueField:'tname'">
            </select>
        </div>
        <div style="margin-bottom:20px">
